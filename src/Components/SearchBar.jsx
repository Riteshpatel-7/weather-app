  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center my-8 gap-4">
      ...
      <button
        ...
        className="font-[DM_Sans] w-[100%] lg:w-auto bg-[hsl(233,67%,56%)] hover:bg-[hsl(233,68%,54%)] transition-colors duration-300 ease-in-out rounded-xl px-6 py-3 text-white text-lg font-medium"
      >
        {btnText}
      </button>
    </div>
